...
- Corrigido um problema em que vários dispositivos de armazenamento USB podiam ser atribuídos ao mesmo ponto de montagem no arranque
...
- Corrigido um problema em que o armazenamento criado a partir de um disco com uma única partição não usava o nome especificado pelo utilizador como ponto de montagem
