...
### Fixed
- Es wurde ein Problem behoben, bei dem auf das Medienverzeichnis nicht zugegriffen werden konnte
- Es wurde ein Problem behoben, bei dem die App-Migration nicht ordnungsgemäß ausgeführt werden konnte
- Es wurde ein Problem behoben, bei dem casaos-every-boot beim Start einen Fehler meldete
- Es wurde ein Problem behoben, bei dem auf Zima nicht über den lokalen Domänennamen zugegriffen werden konnte

### Security
- Ein risikoreiches Sicherheitsproblem im Messaging-Dienst wurde behoben und die Sicherheit der Systemkommunikation verbessert

## [1.6.2-beta2]

### Fixed
- Es wurde ein Problem behoben, bei dem bestimmte Systemverzeichnisse fälschlicherweise als ungültige Pfade identifiziert wurden

### Optimized
- Der Konfigurationsprozess für die Initialisierung des Cloud-Laufwerks wurde in bestimmten Szenarien optimiert und Probleme beim Laden von Dateien behoben, die durch eine langsame Initialisierung verursacht wurden
