...
### Fixed
- Corrigido um problema em que o diretório de mídia não podia ser acessado
- Corrigido um problema em que a migração do aplicativo não funcionava corretamente
- Corrigido um problema em que casaos-every-boot relatava um erro na inicialização
- Corrigido um problema em que o Zima não podia ser acessado através do nome de domínio local
