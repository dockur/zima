...
### Fixed
- Fixed an issue where the media directory could not be accessed
- Fixed an issue where app migration could not run properly
- Fixed an issue where casaos-every-boot reported an error on startup
- Fixed an issue where Zima could not be accessed through the local domain name
