...
### Fixed
- Naprawiono problem uniemożliwiający dostęp do katalogu multimediów
- Naprawiono problem polegający na tym, że migracja aplikacji nie mogła przebiegać poprawnie
- Naprawiono problem polegający na tym, że casaos-every-boot zgłaszał błąd podczas uruchamiania
- Naprawiono problem uniemożliwiający dostęp do Zimy poprzez lokalną nazwę domeny

### Security
- Naprawiono problem bezpieczeństwa wysokiego ryzyka w usłudze przesyłania wiadomości, poprawiając bezpieczeństwo komunikacji systemowej

## [1.6.2-beta2]

### Fixed
- Naprawiono problem polegający na tym, że niektóre katalogi systemowe były błędnie identyfikowane jako nieprawidłowe ścieżki

### Optimized
- Zoptymalizowano proces konfiguracji inicjalizacji dysku w chmurze w określonych scenariuszach, naprawiając problemy z ładowaniem plików spowodowane powolną inicjalizacją
...
- Naprawiono problem polegający na tym, że podczas uruchamiania wiele urządzeń pamięci masowej USB mogło zostać przypisanych do tego samego punktu montowania
- Naprawiono problem polegający na tym, że starsze sufiksy „-nazwa-urządzenia” były generowane w przypadku konfliktu punktów podłączenia USB
