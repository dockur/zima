...
### Fixed
- Riješen je problem zbog kojeg se nije moglo pristupiti direktoriju medija
- Riješen je problem zbog kojeg se migracija aplikacije nije mogla ispravno izvoditi
- Riješen je problem u kojem je casaos-every-boot prijavio pogrešku pri pokretanju
- Riješen je problem zbog kojeg se Zimi nije moglo pristupiti putem naziva lokalne domene

### Security
- Riješen je visokorizični sigurnosni problem u usluzi slanja poruka, poboljšavajući sigurnost komunikacije sustava
...
### Optimized
- Optimiziran je proces konfiguracije inicijalizacije diska u oblaku u određenim scenarijima, popravljajući probleme s učitavanjem datoteka uzrokovane sporom inicijalizacijom
