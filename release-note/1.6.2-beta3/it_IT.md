...
### Fixed
- Risolto un problema per cui non era possibile accedere alla directory multimediale
- Risolto un problema per cui la migrazione dell'app non poteva essere eseguita correttamente
- Risolto un problema per cui casaos-every-boot segnalava un errore all'avvio
- Risolto un problema per cui non era possibile accedere a Zima tramite il nome di dominio locale

### Security
- Risolto un problema di sicurezza ad alto rischio nel servizio di messaggistica, migliorando la sicurezza della comunicazione del sistema

## [1.6.2-beta2]

### Fixed
- Risolto un problema per cui alcune directory di sistema venivano erroneamente identificate come percorsi non validi

### Optimized
- Ottimizzato il processo di configurazione dell'inizializzazione dell'unità cloud in scenari specifici, risolvendo i problemi di caricamento dei file causati da un'inizializzazione lenta
