...
### Fixed
- Rettede et problem, hvor mediebiblioteket ikke kunne tilgås
- Rettede et problem, hvor app-migrering ikke kunne køre korrekt
- Rettede et problem, hvor casaos-every-boot rapporterede en fejl ved opstart
- Rettede et problem, hvor Zima ikke kunne tilgås via det lokale domænenavn

### Security
- Rettede et højrisikosikkerhedsproblem i meddelelsestjenesten, hvilket forbedrede systemkommunikationssikkerheden

## [1.6.2-beta2]

### Fixed
- Rettede et problem, hvor visse systemmapper forkert blev identificeret som ugyldige stier

### Optimized
- Optimerede konfigurationsprocessen for cloud-drevinitialisering i specifikke scenarier, og fikser problemer med indlæsning af filer forårsaget af langsom initialisering
...
- Opdateret Linux-kernen til 6.18.9
