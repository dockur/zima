...
### Fixed
- S'ha solucionat un problema en què no es podia accedir al directori multimèdia
- S'ha solucionat un problema en què la migració d'aplicacions no es podia executar correctament
- S'ha solucionat un problema en què casaos-every-boot informava d'un error a l'inici
- S'ha solucionat un problema en què no es podia accedir a Zima mitjançant el nom de domini local

### Security
- S'ha solucionat un problema de seguretat d'alt risc al servei de missatgeria, millorant la seguretat de la comunicació del sistema
...
- S'ha solucionat de manera urgent un problema de seguretat d'alt risc al servei de fitxers, millorant la seguretat de l'accés i les operacions dels fitxers.
...
### Fixed
- S'ha corregit l'expiració de la clau de OneDrive que provocava problemes de connexió, s'ha restaurat la disponibilitat bàsica d'integració i s'ha optimitzat el mecanisme d'actualització de claus
...
### Tips
- Si trobeu algun problema de programari, no dubteu a unir-vos a la nostra comunitat de Discord per connectar-vos i obtenir el suport de més de 43.000 membres de Zima.
